$(document).ready(function(){
	...
	/*	when page is load successfully then there is a list of departments when user click on category we will get category id and 
	...
	*/
	$("body").delegate(".category","click",function(event){
		...
		var cid = $(this).attr('cid');
			...
			url		:	"action.php",
			method	:	"POST",
			data	:	{get_seleted_Category:1,dept_id:cid},
			success	:	function(data){
				$("#get_product").html(data);
				if($("body").width() < 480){
					$("body").scrollTop(683);
